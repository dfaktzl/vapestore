...
const CONFIG_DEFAULT = {
  ...
  products: [
    ...
    },
    {
      ...
      description: "John Player Special Blue — a quality, affordable cigarette favoured across Australia for its smooth, mellow draw and consistent fine-cut tobacco blend. Each carton contains 10 packs of 20 cigarettes (200 cigarettes total). Sold as a full carton only.",
      inStock: true,
      popular: false
    },
    {
    ...
    /* ==================== BOX-ONLY VAPES (HQD & WAKA) ==================== */
    {
      ...
      description: "WHOLESALE BOX — Our cheapest box deal. Each box contains 10 x HQD Cuvie Bar disposables. Each unit delivers up to 7,000 puffs from 18mL of 5% (50mg/mL) nicotine salt e-liquid. Features a 1.2Ω mesh coil, draw-activated firing, and a 550mAh rechargeable battery (USB Type-C) for extended use. No singles sold.",
      inStock: true,
      popular: true
    },
    {
      ...
      description: "WHOLESALE BOX — Each box contains 10 x Waka SoPro DM8000 disposables. The DM8000 is a premium rechargeable device delivering up to 8,000 puffs from 14mL of 5% nicotine salt e-liquid. Powered by an 850mAh battery (USB Type-C) with DUALMESH™ dual coil technology. Two modes: Boost Mode (max clouds) and Regular Mode (extended lifespan). Smart digital screen shows live battery & e-liquid levels.",
      inStock: true,
      popular: true
    }
  ]
