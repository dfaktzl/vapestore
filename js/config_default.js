...
const CONFIG_DEFAULT = {
  "seo": {
    ...
    "description": "Vape 'R' Aus & Smokes — Australia's trusted outlet for disposable vapes & cigarette cartons. Buy IGET Bar 3500, Alibarbar 8000 & 12000, Waka SoPro DM8000, HQD Cuvie Bar boxes at the lowest prices. Fast express shipping. PayID & bank transfer accepted.",
  ...
  "products": [
    ...
    },
    {
      ...
      "boxPrice": 475.20,
      "isBoxOnly": false,
      "flavors": ["Blue Razz Ice", "Strawberry Watermelon Ice", "Mango Peach Ice", "Grape Ice", "Watermelon Ice", "Lush Ice", "Miami Mint", "Black Mamba", "Strawberry Kiwi", "Peach Mango", "Blue Razz Cherry", "Passion Fruit Mango"],
    ...
    },
    {
      ...
      "boxPrice": 316.80,
      "isBoxOnly": false,
      "flavors": ["Watermelon Ice", "Mango Ice", "Blue Razz Ice", "Strawberry Banana", "Grape Mint", "Peach Ice", "Lush Ice", "Double Apple", "Miami Mint", "Sour Apple Ice", "Strawberry Kiwi"],
      "image": "img/jnr_vapro_7000.webp",
      "description": "The JNR Vapro 7000 is JNR's reliable everyday carry — a compact, slim rechargeable disposable delivering 7,000 puffs from 15mL of 5% (50mg/mL) nicotine salt e-liquid. Features a premium gradient soft-touch finish, precision mesh coil for clean consistent flavour, and USB-C recharging (650mAh battery) to ensure you drain every last drop of e-liquid. Draw-activated, no buttons, no fuss. Perfect entry into the JNR range.",
      "specs": {
        "Puffs": "~7,000 Puffs",
