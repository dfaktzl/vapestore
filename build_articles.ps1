...
<head>
  ...
  <!-- Styles -->
  <link rel="stylesheet" href="../css/design_system.css?v=16">
...
<body id="product-page-marker" data-product-id="$id" style="background-color: #090a0f;">
  ...
  <div class="main-wrapper">
    ...
    <main class="container" style="margin-top: 40px; margin-bottom: 60px;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; background: rgba(255,255,255,0.02); border: 1px solid rgba(212,175,55,0.1); border-radius: 12px; padding: 40px; box-shadow: var(--shadow-lg);">
        ...
        <div style="display: flex; flex-direction: column; justify-content: space-between; text-align: left;">
          <div>
            ...
            <!-- Specs list -->
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px; font-size: 12px; margin-bottom: 30px;">
              $specsHtml
            </div>
  ...
  <!-- scripts -->
  <script src="../js/config_default.js?v=16"></script>
