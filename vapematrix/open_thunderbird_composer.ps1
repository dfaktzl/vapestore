# ==============================================================================
# Vape Matrix - THUNDERBIRD MANUAL EMAIL COMPOSER
# ==============================================================================
...
$bankPayId = "orders@vapematrix.co"
$bankName = "Westpac Banking Corporation"
$bankAccountName = "VAPE MATRIX LOGISTICS"
$bankBsb = "082-902"
$bankAccountNumber = "1829 4829"
...
"@
    ...
    $introHtml = @"
                G'day <strong>$custNameEscaped</strong>,<br><br>
                We're so glad you chose Vape Matrix &mdash; thank you for your order! Since automatic email receipts can sometimes be delayed or blocked by spam filters, we're personally sending this confirmation so you have everything you need to complete your payment and get your order on the way.<br><br>
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color: #0e1014; border: 1px solid rgba(212,175,55,0.15); border-radius: 12px; margin-top: 30px; margin-bottom: 30px; box-shadow: 0 10px 30px rgba(0,0,0,0.6);">
        ...
        <tr>
            <td align="center" style="padding: 20px; background-color: #0c0d12; border-bottom-left-radius: 11px; border-bottom-right-radius: 11px; font-size: 13px; color: #aaaaaa; border-top: 1px solid rgba(255,255,255,0.05); line-height: 1.8;">
                <strong>Thank you so much for supporting Vape Matrix &mdash; we truly appreciate it!</strong><br>
                For any questions, feel free to reply to this email or reach us at $contactEmail.<br><br>
                <strong style="color: #d4af37;">Warm Regards,<br>Vape Matrix Team</strong>
            </td>
        </tr>
    </table>
</body>
...
$tempHtmlPath = [System.IO.Path]::Combine($env:TEMP, "Vape Matrix_order_confirm_$orderId.html")
