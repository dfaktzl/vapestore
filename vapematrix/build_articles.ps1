...
if ($null -eq $siteName) { $siteName = "Vape Matrix" }
$announcement = $settings.announcement
if ($null -eq $announcement) { $announcement = "FREE EXPRESS SHIPPING ON ALL ORDERS OVER `$150!" }
$contactEmail = $settings.contactEmail
if ($null -eq $contactEmail) { $contactEmail = "orders@vapematrix.co" }
...
foreach ($guide in $guides) {
    ...
    $author = $guide.author
    if ($null -eq $author) { $author = "Vape Matrix Education" }
...
<head>
  ...
  <link rel="canonical" href="https://vapematrix.co/education/$id.html">
  
  <!-- Open Graph -->
  <meta property="og:title" content="$title | $siteName">
  <meta property="og:description" content="$summary">
  <meta property="og:type" content="article">
  <meta property="og:url" content="https://vapematrix.co/education/$id.html">
  ...
  <script type="application/ld+json">
  {
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://vapematrix.co/education/$id.html"
    },
    "headline": "$title",
    "description": "$summary",
    "datePublished": "$date",
    ...
    "publisher": {
      ...
      "logo": {
        "@type": "ImageObject",
        "url": "https://vapematrix.co/img/logo.png"
      }
    }
  }
  </script>
...
<body>
  ...
  <div class="main-wrapper">
    ...
    <div class="promo-banner" style="background: linear-gradient(90deg, #12141c 0%, #1d190e 50%, #12141c 100%); border-bottom: 1px solid rgba(212, 175, 55, 0.25); color: #fff; padding: 14px 20px; font-size: 15px; font-family: var(--font-body); display: flex; justify-content: center; align-items: center; gap: 12px; z-index: 1000; position: relative; box-shadow: 0 4px 20px rgba(0,0,0,0.4);">
      ...
      <span style="letter-spacing: 0.2px; text-transform: uppercase; font-weight: 600;">Send in quotes from other shops to our email & we will beat it by 10%! The Bunnings Regulation.</span>
    </div>
    ...
    <header class="main-header">
      <div class="container header-container" style="justify-content: space-between;">
        <a href="../index.html" class="logo-link" style="display:flex; align-items:center; height:100%;">
          <img src="../img/logo.png" alt="Vape Matrix Logo" style="height:50px; object-fit:contain; filter: drop-shadow(0 0 4px rgba(255,255,255,0.15));">
        </a>
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <url>
    <loc>https://vapematrix.co/index.html</loc>
    <priority>1.0</priority>
  </url>
  <url>
    <loc>https://vapematrix.co/catalog.html</loc>
    <priority>0.9</priority>
  </url>
  <url>
    <loc>https://vapematrix.co/guides.html</loc>
    <priority>0.9</priority>
  </url>
  <url>
    <loc>https://vapematrix.co/contact.html</loc>
...
foreach ($guide in $guides) {
  ...
  <url>
    <loc>https://vapematrix.co/education/$id.html</loc>
    <priority>0.8</priority>
  </url>
"@
}
